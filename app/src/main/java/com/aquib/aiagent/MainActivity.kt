...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSave.setOnClickListener {
            securePrefs.putString("active_api_key", etApiKey.text?.toString().orEmpty())
...
Microphone: ${status(checkSelfPermission(android.Manifest.permission.RECORD_AUDIO) == android.content.pm.PackageManager.PERMISSION_GRANTED)}
...
""".trimIndent()
    ...
    private fun startForegroundServices() {
        val overlayIntent = Intent(this, com.aquib.aiagent.overlay.AgentOverlayService::class.java)
